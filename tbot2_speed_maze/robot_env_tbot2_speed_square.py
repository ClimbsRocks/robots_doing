...
# TODO: should we use this, or the version we defined ourselves?
from openai_ros import robot_gazebo_env

class CartPoleEnv(robot_gazebo_env.RobotGazeboEnv):


    def __init__(self, robot_name_space, reset_controls=True):

        self.publishers_array = []
        self.cmd_vel_pub = rospy.Publisher('/cmd_vel', Twist, queue_size=5)
        self.publishers_array.append(self.cmd_vel_pub)
